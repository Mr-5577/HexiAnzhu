...
import DisputApproval from "./disput-approval/index.vue";
import Documents from "./documents/index.vue";
import ContractSettlement from "./contract-settlement/index.vue";
import ContractTermination from "./contract-termination/index.vue";
import OutputDeclaration from "./output-declaration/index.vue";
import PaymentAdjust from "./payment-adjust/index.vue";
import PaymentApplication from "./payment-application/index.vue";
import PerformanceBond from "./performance-bond/index.vue";
...
const tabComponents = {
  ...
  documents: Documents, // 收文发文
  disputeApproval: DisputApproval, // 争议审批
  contractSettlement: ContractSettlement, // 合同结算
  contractTermination: ContractTermination, // 合同解除
  outputDeclaration: OutputDeclaration, // 产值申报
  paymentAdjust: PaymentAdjust, // 款项调整
  paymentApplication: PaymentApplication, // 付款申请
  performanceBond: PerformanceBond, // 履约保证金
};
