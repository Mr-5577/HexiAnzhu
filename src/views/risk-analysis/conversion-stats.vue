    ...
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        ...
        <el-button
          ...
          @click="handleExport"
          :disabled="!menuStore.hasExactPermission('conversion-stats:export')"
        >
          导出
        </el-button>
      </el-form-item>
...
import { ConversionStatsInterface } from "@/types/sales/risk-analysis-type";
...
defineOptions({ name: "conversion-stats" });
...
const handleExport = async () => {
  try {
    ...
    const fileBlob =
      await assetManagementApi.exportOrderToSignPeriodProj(params);
