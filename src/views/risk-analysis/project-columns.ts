...
export const premiumStatsColumns = [
  ...
  { prop: "allNum", label: "认购套数", width: 90, showSummary: true },
  {
    prop: "saleArea",
    label: "销售面积",
    width: 100,
...
export const receivablesDetailColumns = [
  ...
  { prop: "roomNum", label: "房号", width: 100 },
  { prop: "buildArea", label: "预测面积", width: 100 },
  { prop: "custName", label: "业主", width: 120 },
  { prop: "custTel", label: "联系电话", width: 120 },
  { prop: "payWayName", label: "付款方式", width: 100 },
  { prop: "saleDate", label: "认购日期", width: 100 },
  { prop: "signDate", label: "签约时间", width: 100 },
  { prop: "netDate", label: "网签日期", width: 100 },
  {
    prop: "saleMoney",
    label: "认购金额",
    formatter: ({ saleMoney }: { saleMoney: NumStr }) =>
  ...
  { prop: "minRecDate", label: "最近应收日期", width: 120 },
  {
    prop: "yqMoney",
    label: "逾期未收金额",
  ...
  { prop: "maxYqDays", label: "最大逾期天数", width: 120 },
  { prop: "reasonTypeName", label: "未回款原因", width: 200 },
  { prop: "reasonDesc", label: "未回款说明", width: 200 },
  { prop: "reasonDate", label: "登记日期", width: 100 },
];
// 应收账龄明细-表头
