...
import { pendingDetailColumns } from "./project-columns";
import { useSalesData } from "@/composables/use-sales";
import { dateUtil } from "@/utils/date-util";
import { assetManagementApi } from "@/api/sales/asset-management-api";
import { PendingDetailInterface } from "@/types/sales/risk-analysis-type";
...
defineOptions({ name: "pending-detail" });
...
const tableData = ref<PendingDetailInterface[]>([]);
const allTableList = ref<PendingDetailInterface[]>([]);
...
const handleExport = async () => {
  try {
    ...
    const fileBlob =
      await assetManagementApi.exportOrderNotSignInfoRoom(params);
