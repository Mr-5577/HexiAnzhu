<!-- 销售年报表(树) -->
<template>
  <div class="tree-annual-report-page">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        ...
        <el-button
          ...
          @click="handleExport"
          :disabled="!menuStore.hasExactPermission('tree-annual-report:export')"
        >
          导出
        </el-button>
      </el-form-item>
...
defineOptions({ name: "tree-annual-report" });
...
const getTableList = async () => {
  try {
    ...
    const res = await assetManagementApi.getSaleYearReportTree(params);
    if (res.code === 200) {
...
const handleExport = async () => {
  try {
    ...
    const fileBlob = await assetManagementApi.exportSaleYearReportTree(params);
